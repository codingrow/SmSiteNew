...
$routing = [['/p/{_method}/{file}', 'public@@css', ['{file}' => '[a-zA-Z0-9_.-]+']], ['/user/{_method}', 'user@index', []], ['/group/{_method}', 'group@index', []], ['/manage/{_method}', 'manage@index', []], ['/base/{_method}', 'Base@index', []], ['/employees/{_method}', 'employees@index', []], ['/logout', 'user@logout', []], ['/user/view/{view}', 'user@view', ['{view}' => '[A-z]+']], ['/me', 'user@me', []], ['/msg/{message}/{code}', 'response@controller', ['{message}' => '[\d]+']], ['/home', 'Base@index', []], ['/test/{_method}', 'test@index', []]
];
